var put_info = function (){
	...
	var anonym = {
		...
		text: [	
			...
			"<li style='list-style-type:square;'> les valeurs données à l'échelle de compréhension, métaphoricité, beauté et familiarité des 40 extraits</li>"+
			"<li style='list-style-type:square;'> les valeurs des réponses contrôles</li>"+
			"<li style='list-style-type:square;'> les valeurs du questionnaire de reconnaissance d’auteurs</li>"+		
